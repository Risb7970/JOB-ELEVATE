...
const Working = () => {
    return (
        <div className='mt-20 pb-5'>
            <div className='text-4xl  bs-mx:text-3xl md-mx:text-2xl xs-mx:text-xl  text-center font-semibold mb-3 text-mine-shaft-100'>How it <span className='text-bright-sun-400'>Works</span></div>
            <div className="text-lg mb-10 sm-mx:text-base xs-mx:text-sm text-mine-shaft-300 text-center w-1/2 sm-mx:w-11/12 mx-auto">Effortlessely navigate through the process and land your
                dream job.</div>
            <div className="flex px-16 bs-mx:px-10 gap-2 md-mx:flex-col  md-mx:px-5 justify-between items-center ">
                <div className="relative">
                    ...
                    <div className="w-36 xs-mx:w-28 flex flex-col items-center gap-1 border border-bright-sun-400 rounded-xl py-3 px-1 
                    backdrop-blur-md top-[15%] right-0 absolute">
                        <Avatar className="!h-16 !w-16 xs-mx:!h-12 xs-mx:!w-12" src="avatar2.png" alt="it's me" />
