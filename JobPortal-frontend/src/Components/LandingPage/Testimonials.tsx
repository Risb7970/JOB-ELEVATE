    ...
    return (
        <div className='mt-20 pb-5 p-5'>
            <div className='text-4xl md-mx:text-3xl sm-mx:text-2xl xs-mx:text-xl text-center font-semibold mb-3 text-mine-shaft-100'>What
               ...
               {
                    testimonials.map((data,index)=> <div key={index} className="flex flex-col gap-3 w-[23%] md-mx:w-[48%] xs-mx:w-full
                     border-bright-sun-400 p-3 border rounded-xl ">
                    <div className="flex gap-2 items-center">
                        <Avatar className="!h-14 !w-14" src="avatarpro.png" alt="it's me" />
                        <div>
