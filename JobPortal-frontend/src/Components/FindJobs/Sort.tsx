...
const Sort=(props:any)=> {
  ...
  return (
      ...
      >
        <Combobox.Target>
          <div onClick={()=>combobox.toggleDropdown()} className='cursor-pointer gap-2 text-sm xs-ms:text-xs border
           border-bright-sun-400 flex px-2 py-1 xsm-mx:mt-2 xs-mx:px-1 xs-mx:py-0 rounded-xl items-center'>
